...
const Footer = () =>
    <footer>
        ...
        <span className="footer-item">Restaurants information provided by&nbsp;&nbsp;<a href="https://www.yelp.com/" target="_blank" rel="noopener noreferrer"><img id='yelp-logo' src={process.env.PUBLIC_URL + '/yelp_logo.png'} alt="Yelp" /></a></span>
    </footer>
